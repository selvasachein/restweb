...
<body >
    ...
    <h2>one of the most trusted and valuble restaurants</h2>
    <h2>PRODUCTS</h2>
    <a href="sign.html">
...
<footer style="background-color:darkmagenta;margin-top: 230; border: none;">
    <P style="color:#ffffff; ;"align="center">Designed and Devoloped by JAYARAJ B 24013576 </P>
</footer>
</html>
...
<body>
    ...
    <div class="photos">
    <img src="6660.jpg" height="200" width="180">
    <img src="vijay.jpg" height="200" width="200">
    <img src="ajith.jpg" height="200" width="200">
    <img src="surya.jpg" height="200" width="200">
    <img src="dhanush.jpg" height="200" width="200">
    <img src="adithya varma.jpg" height="200" width="200">
    <img src="siva.jpg" height="200" width="200">
</div>
<div CLASS="names">
    <P>MR Jayaraj</P>    
...
<body>
    ...
    <div class="form">
        <p align="center">JOIN THE FAMILY OF Foodies HUB</p>
...
<body>
    ...
    <div class="company">
        <center>
        <h3 style="color: rgb(15, 16, 17);"> RESTAURANT CONTACT INFORMATION</h3>
       <p> <b >Address</b></p>
        <p >22,ANNA NAGAR,</p>
        <p >ANNA NAGAR POST</p>
        <p >CHENNAI-600056</p>
        <b >Email:</b>
        <p >jayaraj.bf1@gmail.com</p>
        <b >Phone</b>
        <p >8148009299</p>
    </center>
    </div>
...
<html>
    ...
    <body>
        ...
        <img src="menu.jpg" height="500" width="800">
    </center>
    </body>
...
![web-output](https://github.com/user-attachments/assets/b881a4e8-b65d-4fca-9e38-94e4f0f118cc)
![product-output](https://github.com/user-attachments/assets/5edcc756-24aa-4010-9621-d8db2ea3d7ef)
![sign-output](https://github.com/user-attachments/assets/e5810b5c-76aa-4f3b-bce5-bf3e181bfbd9)
![contact-output](https://github.com/user-attachments/assets/289a4798-bdf6-4776-b8e3-55b1f5b06458)
![about-output](https://github.com/user-attachments/assets/2d8cf8b3-06a0-4581-ba94-201c71f9d30b)
